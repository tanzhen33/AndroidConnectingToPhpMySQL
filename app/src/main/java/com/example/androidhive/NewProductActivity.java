...
public class NewProductActivity extends Activity {
	...
	EditText inputProductid;
    EditText inputDepartment;
	EditText inputName;
	EditText inputAddress;
	EditText inputPrice;
	EditText inputProductType;
	EditText inputDesc;

	// url to create new product
	private static String url_create_product = "http://172.19.15.210/android_connect/create_product.php";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		inputProductType = (EditText) findViewById(R.id.inputProductType);
	...
	class CreateNewProduct extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... args) {
			...
			params.add(new BasicNameValuePair("producttype", producttype));
