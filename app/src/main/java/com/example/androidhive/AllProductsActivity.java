...
public class AllProductsActivity extends ListActivity {
	...
	private static String url_all_products = "http://172.19.15.210/android_connect/get_all_products.php";
			...
			try {
				...
				if (success == 1) {
					...
					for (int i = 0; i < products.length(); i++) {
						...
						map.put(TAG_PID, id);
						map.put(TAG_PRODUCTID, productid);
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					ListAdapter adapter = new SimpleAdapter(
							...
							new String[] {TAG_PID,TAG_PRODUCTID,TAG_DEPARTMENT,TAG_NAME},
							new int[] {R.id.pid, R.id.productid,R.id.department,R.id.name});
					// updating listview
